...
export default function AddUser() {
  ...
  const handleAddUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.from('Users').insert({
        ...
        Email: email,
        Tel: tel,
        Password: password, // สามารถบันทึกรหัสผ่านไปในตารางนี้ (ควรทำการ hash รหัสผ่านก่อนเก็บในกรณีจริง)
  ...
  return (
    <div className="p-10 bg-orange-100 min-h-screen">
      ...
      <form onSubmit={handleAddUser} className="mt-8 space-y-6 px-32">
        <h2 className="text-5xl mb-4 font-bold">Add User</h2>
