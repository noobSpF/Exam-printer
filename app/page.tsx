    ...
    <div className="flex min-h-screen">
      ...
      <aside className="w-64 bg-gray-800 text-white flex flex-col">
        ...
        <nav className="mt-10 flex-grow">
          <ul>
            <li className="px-4 py-2 bg-gray-700">All exam</li>
            <li className="px-4 py-2">Backup exam</li>
          </ul>
        </nav>
      </aside>
      ...
      <div className="flex-grow flex flex-col">
        <div className="flex justify-between items-center p-4 bg-gray-100">
          ...
          <div className="relative">
            <button className="w-10 h-10 bg-gray-300 text-white rounded-full flex justify-center items-center">
              👤
            </button>
          </div>
        </div>
        ...
        <main className="p-6 bg-gray-100 flex-grow">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">All exam</h2>
